        ...
        <div className="w-full space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-sm text-brand-500 mt-1">Manage your persistent professional documents securely.</p>
                </div>
                <label className="cursor-pointer bg-brand-900 text-white px-6 py-3 rounded-xl font-bold text-sm shadow-xl hover:bg-brand-800 transition-all active:scale-95 flex items-center space-x-2">
            ...
            <div className="bg-white border border-brand-100 rounded-3xl p-6 shadow-subtle space-y-6">
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="w-full pl-11 pr-4 py-3 bg-brand-50/50 rounded-2xl border border-brand-100 text-sm focus:ring-4 focus:ring-brand-900/5 transition-all outline-none"
                        value={searchQuery}
                            ...
                            filteredResumes.map((r, idx) => (
                                ...
                                >
                                    ...
                                    <div className="mt-4 relative z-10">
                                        <h4 className="font-bold text-brand-900 truncate mb-1">{r.filename}</h4>
