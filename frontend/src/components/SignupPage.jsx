...
import { UserPlus, Mail, Lock, User, Briefcase, Loader2, AlertCircle, Sparkles, ArrowLeft, ChevronDown, CheckCircle2, Inbox } from 'lucide-react';
                ...
                {!signupSuccess ? (
                    ...
                    >
                        <div className="flex justify-center">
                            <div className="w-16 h-16 bg-blue-500/10 text-blue-500 dark:text-blue-400 rounded-2xl flex items-center justify-center shadow-inner animate-pulse">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                                Welcome aboard, <strong>{formData.name}</strong>! We've dispatched a secure confirmation link to <strong>{formData.email}</strong>.
                            </p>
                            <div className="bg-slate-50 dark:bg-slate-950/50 border border-slate-200/50 dark:border-slate-800/50 p-3.5 rounded-2xl text-[11px] font-bold text-slate-600 dark:text-slate-400 text-left mt-4 space-y-1.5">
                                <div className="flex items-start gap-2">
                                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 shrink-0 mt-0.5" />
                                    <span>Check your inbox and spam folders for a "Confirm your CareerForge Email" subject.</span>
                                </div>
                            </div>
                        </div>
                        <div className="pt-4">
                            <Link 
                                to="/login" 
                                className="w-full py-3.5 bg-slate-900 dark:bg-accent-600 text-white rounded-xl font-bold shadow-lg block hover:scale-[1.01] active:scale-[0.98] transition-all"
                            >
                                Return to Sign In
                            </Link>
                        </div>
